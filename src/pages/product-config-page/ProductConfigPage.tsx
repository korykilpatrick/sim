...
import { VesselTrackingConfig } from '@features/product-config/components/VesselTrackingConfig';
import { AreaMonitoringConfig } from '@features/product-config/components/AreaMonitoringConfig';
import { MaritimeAlertConfig } from '@features/product-config/components/MaritimeAlertConfig';
import { ReportConfig } from '@features/product-config/components/ReportConfig';
import { InvestigationRFIForm } from '@features/product-config/components/InvestigationRFIForm';

    ...
    <footer className="bg-navy-900 text-white py-8 border-t border-navy-700">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 text-ocean-300">SYNMAX MARITIME</h3>
            <p className="text-ocean-100">
              Actionable Intelligence at Sea
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/auth/login" className="text-ocean-100 hover:text-ocean-300">
                  Login
                </Link>
              </li>
              <li>
                <Link to="/auth/register" className="text-ocean-100 hover:text-ocean-300">
                  Register
                </Link>
              </li>
            </ul>
